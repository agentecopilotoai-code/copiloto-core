...
| BUG-083 | [#188](https://github.com/vmantilla/CopilotoIA/pull/188#discussion_r3250224620) | `admin-panel/src/app/shells/shell.module.css:28` | Sidebar colapsada (4rem) deja ~32px content → header controls overflow con `overflow: hidden` | PENDING-MINOR-UX (deferido — afecta edge cases en viewports muy estrechos, no bloquea uso normal) |
