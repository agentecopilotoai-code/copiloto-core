...
| BUG-047 | [#94](https://github.com/vmantilla/CopilotoIA/pull/94#discussion_r3231330655) | `app/services/metrics.py` | Alertas `cpi_backup_last_*` nunca registradas → expression vacía → backups stale nunca paginan | PENDING-INFRA (requiere instrumentar backup verifier con Prometheus, fix-group futuro) |
