...
| BUG-096 | [#173](https://github.com/vmantilla/CopilotoIA/pull/173#discussion_r3248634277) | `app/api/v1/routes.py` (brand_logo upload) | `brand_logo_url` set a `stored.source_uri` (`file://`/`s3://`) → UI rompe imágenes | PENDING-INFRA (requiere endpoint media proxy / presigned URLs) |
