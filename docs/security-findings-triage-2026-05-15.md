...
- **VÁLIDO (código vulnerable persiste):** 6 (0 high + 6 low) — actualizado 2026-05-15 tras PR SEC-008 + PR SEC-009 + re-spot-check de `ddce83b1` (cloud LLM DoS) que resultó RESOLVED por TASK-0086.
