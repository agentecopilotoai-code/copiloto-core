...
async def lifespan(app: FastAPI):  # pragma: no cover - lifespan only runs in a real ASGI server
    from copiloto_core.admin.oauth_state_store import close_oauth_state_store
    from copiloto_core.admin.session_store import close_session_store
    from copiloto_core.services.http_clients import close_all as close_http_clients
