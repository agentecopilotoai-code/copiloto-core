...
from copiloto_core.admin.config import get_admin_settings
from copiloto_core.admin.ws_fanout import fanout as ws_fanout
from copiloto_core.core.security import (
    PRIVILEGED_ROLES as _PRIVILEGED_ROLES,
    decode_auth0_id_token,
)
from copiloto_core.core.signed_cookies import (
...
router = APIRouter()
# P0-3 (M70) — sessions live in pluggable store (`copiloto_core.admin.session_store`).
...
async def _active_session_id(session_id: str | None) -> dict[str, Any] | None:
    ...
    if not session_id:
        ...
        return None
    from copiloto_core.admin.session_store import get_session_store  # noqa: PLC0415
...
def _tenant_id_from_support_cookie(request: Request) -> str | None:
    ...
    El cookie es un payload firmado por `jwt_secret` (ver `copiloto_core.core.signed_cookies`).
    ...
    from copiloto_core.core.security import SUPPORT_MODE_COOKIE_NAME  # noqa: PLC0415
    from copiloto_core.core.signed_cookies import unpack_signed_payload  # noqa: PLC0415
...
async def invitation_landing(token: str, request: Request) -> Response:
    ...
    from copiloto_core.services.http_clients import get_core_bff_client  # noqa: PLC0415
    try:
...
async def admin_callback(
    ...
    from copiloto_core.admin.oauth_state_store import get_oauth_state_store  # noqa: PLC0415
    ...
    from copiloto_core.services.http_clients import get_auth0_client  # noqa: PLC0415
