...
def _reject_unsafe_provider_url(url: str, *, field: str) -> None:
    """SEC-019 (audit #2) — wrapper sobre `copiloto_core.services.url_safety` que
    ...
    from copiloto_core.services.url_safety import UrlSafetyError, check_provider_url  # noqa: PLC0415
...
from copiloto_core.ai.providers.base import (  # noqa: E402
    PersonaAnchor,
...
from copiloto_core.core.config import get_settings  # noqa: E402
...
def _build_test_provider(provider_name: str, *, api_key: str, model: str | None):
    ...
    if provider_name == 'grok':
        from copiloto_core.ai.providers.grok import GrokProvider  # local import: evita ciclos
        models: dict[str, str] = {}
