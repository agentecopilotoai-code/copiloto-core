...
from copiloto_core.api.v1.routes import platform_admin_router, tenant_management_router
from copiloto_core.api.v1.schemas import TenantCreate, TenantUpdate
from copiloto_core.core.security import require_tenant_management
from copiloto_core.db.pool import get_db, record_to_dict
from copiloto_core.services import locale as locale_service
...
async def add_tenant_member(
    ...
    """
    from copiloto_core.services import auth0_admin  # noqa: PLC0415
    ...
    from copiloto_core.services.invitations import (  # noqa: PLC0415
...
async def get_platform_health(
    ...
    from copiloto_core.core.security import get_session_revoke_failopen_count  # noqa: PLC0415
...
# `auth_subject` y delega a `copiloto_core.services.auth0_admin`. Si el user
