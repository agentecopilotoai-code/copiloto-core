...
from copiloto_core.api.v1.routes import tenant_signup_router
...
async def create_own_tenant(
    ...
    from copiloto_core.services.sliding_window_rate_limit import _build_sync_check  # noqa: PLC0415
