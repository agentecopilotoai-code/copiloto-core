...
from copiloto_core.services.locale import SUPPORTED_COUNTRIES

# Solo vendemos a 7 países LatAm. Patrón viene del catálogo autoritativo
# de `copiloto_core.services.locale` para evitar drift.
...
class TenantCreate(BaseModel):
    ...
    # ``copiloto_core.services.locale.default_timezone``.
