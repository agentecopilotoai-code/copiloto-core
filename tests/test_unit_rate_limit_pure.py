...
def test_token_bucket_starts_full():
    from copiloto_core.services.rate_limit import TokenBucket
...
def test_rate_limiter_invalid_config_raises():
    from copiloto_core.services.rate_limit import RateLimiter
...
def test_classify_scope_webhook_prefix():
    from copiloto_core.services.rate_limit import classify_scope
...
def test_build_rate_limit_key_with_tenant():
    from copiloto_core.services.rate_limit import build_rate_limit_key
...
def test_extract_client_ip_uses_peer_when_trust_xff_false(monkeypatch):
    from copiloto_core.services import rate_limit
