"""Tests para `copiloto_core.admin.session_store` (M70 / P0-3 audit 2026-05-27).
...
def test_inmemory_get_miss_returns_none():
    from copiloto_core.admin.session_store import InMemorySessionStore
...
def test_factory_returns_inmemory_when_no_redis_url(monkeypatch):
    from copiloto_core.admin import config, session_store
...
def test_factory_caches_store_between_calls(monkeypatch):
    from copiloto_core.admin import session_store
    session_store.set_session_store_for_tests(None)
