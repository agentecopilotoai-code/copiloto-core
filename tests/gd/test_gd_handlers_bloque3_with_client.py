...
- /v1/gd/admin/dependencias (GET, POST, PATCH, /cerrar-vigencia)
- /v1/gd/admin/estructura/versiones (POST)
- /v1/gd/admin/estructura/vigente, /v1/gd/admin/estructura/historica
"""
...
class TestDependenciasHandlers:
    def test_get_lista_plana(self, conn, client):
        ...
        r = client.get('/v1/gd/admin/dependencias')
        assert r.status_code == 200
    ...
    def test_get_jerarquia(self, conn, client):
        ...
        r = client.get('/v1/gd/admin/dependencias?incluir_jerarquia=true')
        assert r.status_code == 200
        body = r.json()
        assert 'raiz' in body
    ...
    def test_patch_dependencia_ok(self, conn, client):
        ...
        r = client.patch(
            f'/v1/gd/admin/dependencias/{uuid4()}',
    ...
    def test_cerrar_vigencia_ok(self, conn, client):
        ...
        r = client.post(
            f'/v1/gd/admin/dependencias/{uuid4()}/cerrar-vigencia',
            json={
...
class TestEstructuraHandlers:
    def test_post_version_estructura_ok(self, conn, client):
        ...
        r = client.post(
            '/v1/gd/admin/estructura/versiones',
            json={
                'numero_version': 'v1.0',
                'fecha_inicio_vigencia': '2026-01-01',
            },
    ...
    def test_get_vigente_ok(self, conn, client):
        ...
        r = client.get('/v1/gd/admin/estructura/vigente')
        assert r.status_code == 200
    ...
    def test_get_historica_ok(self, conn, client):
        ...
        r = client.get('/v1/gd/admin/estructura/historica?fecha=2024-06-15')
        assert r.status_code == 200
        assert r.json()['numero_version'] == 'v0.9'

    def test_get_historica_sin_resultado(self, conn, client):
        conn.fetchrow.return_value = None
        r = client.get('/v1/gd/admin/estructura/historica?fecha=2020-01-01')
        assert r.status_code == 404
